...
/datum/preferences
	...
	var/list/features = list("mcolor" = "FFF",
		...
		"balls_cum_rate" = BALLS_CUM_RATE,
		"balls_cum_mult" = BALLS_CUM_RATE_MULT,
		"balls_efficiency" = BALLS_CUM_EFFICIENCY,
		"balls_max_vol_ratio" = BALLS_MAX_VOL_RATIO,
		"balls_volume_base"	= BALLS_VOLUME_BASE,
		"balls_fluid" = /datum/reagent/consumable/semen,
		"balls_producing"	= TRUE,
		"has_ovi" = FALSE,
		"ovi_shape" = "knotted",
		"ovi_length" = 6,
		"ovi_color" = "fff",
		...
		"breasts_size" = "C",
		"breasts_shape" = "Pair",
		"breasts_cum_rate"	= BREASTS_CUM_RATE,
		"breasts_cum_mult"	= BREASTS_CUM_RATE_MULT,
		"breasts_efficiency"= BREASTS_CUM_EFFICIENCY,
		"breasts_max_vol_ratio" = BREASTS_MAX_VOL_RATIO,
		"breasts_volume_base" = BREASTS_VOLUME_BASE,
		...
		"has_womb" = FALSE,
		"can_get_preg" = FALSE,
		"womb_cum_rate" = WOMB_CUM_RATE,
		"womb_cum_mult" = WOMB_CUM_RATE_MULT,
		"womb_efficiency" = WOMB_CUM_EFFICIENCY,
		"womb_max_vol_ratio"= WOMB_MAX_VOL_RATIO,
		"womb_volume_base"	= WOMB_VOLUME_BASE,
